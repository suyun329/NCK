...
<%
    ...
    if (nckID == 0)
    {
        PrintWriter script = response.getWriter();
        script.println("<script>");
        script.println("location.href = 'bidding.jsp'");
        script.println("</script>");
    }
...
<div id="dt-area" class="section">
   <div id="info">
      <img class="pd_img" src="/NCK/register/<%=nck.getNckReImg()%>">
...
<%= nck.getNckEx() %>
   ...
   <div class="fixedA">
      <div class="prinow">
         ...
         <p class="term" id="pn" value="<%= nck.getNckHit() %>"><%= nck.getNckCurrent()%></p><!--현재가: now--><p id="pn">&nbsp; 원</p>
      </div>
   </div>
   <div class="fixedB">
      <div class="unit">
